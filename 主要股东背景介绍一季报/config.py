...
class AIConfig:
    ...
    file_upload_timeout: int = int(os.getenv('AI_FILE_UPLOAD_TIMEOUT', '10'))
...
class DownloadConfig:
    """下载配置"""
    download_url_template: str = 'http://10.6.1.131/rfApi/file/downloadWithAppId/{appId}?appId=rc-as'
    download_timeout: int = int(os.getenv('DOWNLOAD_TIMEOUT', '60'))
    chunk_size: int = int(os.getenv('CHUNK_SIZE', '8192'))
    max_download_workers: int = int(os.getenv('MAX_DOWNLOAD_WORKERS', '10'))
