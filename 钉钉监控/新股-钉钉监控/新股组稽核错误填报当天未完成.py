...
def message_trans(sql_result):
    ...
    if sql_result:
        header = '## <font color=#ff6700>新股组-稽核错误当天未及时修正提醒</font>\n'
    else:
        header = '## <font color=#00BFFF>新股组-稽核错误当天未及时修正提醒</font>\n'
    ...
    if sql_result:
        ...
        body += ">  144数据库查询语句： \n select YWX team, PTID from dbo.usrNBSYJHCWTB where (YWX = 'A股-新股组') and (SCSFJS is null) and SJJHRQ >= '2024-08-01'"
    else:
