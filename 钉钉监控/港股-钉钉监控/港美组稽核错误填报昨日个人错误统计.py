...
def message_trans(result):
    ...
    if sql_result1:
        header1 = '## <font color=#FF3E96>港美组-昨日个人错误情况统计</font>\n'
        body += header1
        body += f'>  <font color=#FF3E96>统计日期： {sql_result1[0][-1]}</font>\n'
        his_calc = 0
        new_calc = 0
        ...
        body += f'\n<font color=#FF3E96>【合计】昨日日增错误：{new_calc}条；历史错误：{his_calc}条</font>\n'
        ...
        body += '## <font color=#FF3E96>打的赢，霸得蛮，高质量发展！</font>\n'
