...
def message_trans(result):
    ...
    if sql_result1:
        header1 = '## <font color=#ff6700>特别组上周错误情况</font>\n'
        body += header1
        ...
        header1 = '## <font color=#00BFFF>特别组-上周错误情况</font>\n'
        body += header1
        body += f'>  取值区间： {sql_result4[0][1]} 至 {sql_result4[0][0]}\n'
        body += '+  “有则改之，无则加勉。” ——宋·朱熹《论语集注·学而篇第一》\n\n '

    if sql_result2:
        header2 = '## <font color=#ff6700>特别组-截止上周无改进措施</font>\n'
        body += header2
        ...
        header2 = '## <font color=#00BFFF>特别组-截止上周无改进措施</font>\n'
        body += header2
        body += f'>  截止日期：  {sql_result4[0][0]}\n'
        body += '+  “过而不能知，是不智也；知而不能改，是不勇也。” ——北宋·李觏《易论第九》\n\n '

    if sql_result3:
        header3 = '## <font color=#ff6700>特别组-截止上周无效改进措施</font>\n'
        body += header3
        body += f'>  截止日期：  {sql_result4[0][0]}\n'
        ...
        header3 = '## <font color=#00BFFF>特别组-截止上周无效改进措施</font>\n'
        body += header3
        body += f'>  截止日期：  {sql_result4[0][0]}\n'
