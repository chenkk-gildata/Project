...
def message_trans(sql_result):
    ...
    if sql_result:
        header = '## <font color=#ff6700>领导人介绍-稽核错误未及时修正提醒</font>\n'
    else:
        header = '## <font color=#00BFFF>领导人介绍-稽核错误未及时修正提醒</font>\n'
    ...
    if sql_result:
        ...
        body += ">  144数据库查询语句： \n select YWX team, PTID from dbo.usrNBSYJHCWTB where (YWX = 'A股-特别组' or YWX = 'A股-衍生组') and (SCSFJS is null or TBSFRK is null) and SJJHRQ >= '2026-01-01'"
    else:
