...
def tp_check():
    ...
    sql = """
        ...
        join task_pool_config b on a.pool_config_id = b.id and (locate('生产任务-股票任务-A股特别岗-衍生', b.combination_name ) = 1 or
        locate('生产任务-股票任务-A股特别岗-特别', b.combination_name ) = 1)
...
def dingding(message):
    # webhook_url = 'https://oapi.dingtalk.com/robot/send?access_token=3050a412c9039d5d3471f64b9b6b23463d6c79bc5cb6fe217ea915542855cf8c' # test
